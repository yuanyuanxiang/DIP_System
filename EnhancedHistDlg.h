...
class CEnhancedHistDlg : public CDialog
{
	DECLARE_MESSAGE_MAP()
	DECLARE_DYNAMIC(CEnhancedHistDlg)
...
public:
	...
	CEnhancedHistDlg(CWnd* pParent = NULL);	// 标准构造函数
	virtual ~CEnhancedHistDlg();
