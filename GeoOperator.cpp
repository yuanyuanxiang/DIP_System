...
*	返回值:			是否成功
******************************************************************************/
bool MoveTransNormal(BYTE* pixel, BYTE*& tempPixel, int width, int height, int xx, int yy)
{
	// 输出图像大小
...
******************************************************************************/
void MoveTransSize(BYTE* pixel, BYTE*& tempPixel, int width, int height, int xx, int yy, UINT& outWidth, UINT& outHeight)
{
...
*		fy			垂直缩放系数
******************************************************************************/
void ZoomNormal(BYTE* pixel, BYTE*& tempPixel, int width, int height, UINT& outWidth, UINT& outHeight, double fx, double fy)
{
	// 计算缩放后的图像大小
...
*		fy			垂直缩放系数
******************************************************************************/
void ZoomInterpolation(BYTE* pixel, BYTE*& tempPixel, int width, int height, UINT& outWidth, UINT& outHeight, double fx, double fy)
{
	// 计算缩放后的图像大小
...
*		angle		旋转度数,以弧度表示
******************************************************************************/
void RotateNormal(BYTE* pixel, BYTE*& tempPixel, int width, int height, UINT& outWidth, UINT& outHeight, double angle)
{
	// 原始图像四个角的坐标
...
*		angle		旋转度数,以弧度表示
******************************************************************************/
void RotateInterpolation(BYTE* pixel, BYTE*& tempPixel, int width, int height, UINT& outWidth, UINT& outHeight, double angle)
{
	// 原始图像四个角的坐标
	int srcX1, srcX2, srcX3, srcX4;
	int srcY1, srcY2, srcY3, srcY4;
